...
impl IntelGm965 {
    ...
    fn smi_enable_for_relocation() {
        let pm = crate::pmio_ich::PmIo::new(ICH8_PMBASE);
        pm.setbits32(
            crate::pmio_ich::SMI_EN,
            crate::pmio_ich::APMC_EN | crate::pmio_ich::GBL_SMI_EN | crate::pmio_ich::EOS,
        );
    }
    ...
    fn thermal_sensor_init(
        ...
        smbus: &mut crate::smbus::I801SmBus,
    ) {
...
impl SmmOps for IntelGm965 {
    ...
    fn post_smm_init(&self) {
        ...
        pm.write16(
            crate::pmio_ich::PM1_EN,
            crate::pmio_ich::PWRBTN_EN | crate::pmio_ich::GBL_EN,
        );
        pm.write32(
            crate::pmio_ich::SMI_EN,
            crate::pmio_ich::TCO_EN
                | crate::pmio_ich::APMC_EN
                | crate::pmio_ich::SLP_SMI_EN
                | crate::pmio_ich::GBL_SMI_EN
                | crate::pmio_ich::EOS,
        );
        self.smm_lock();
...
impl MemoryController for IntelGm965 {
    fn dram_init(&mut self) -> Result<(), ServiceError> {
        let mut smbus = crate::smbus::I801SmBus::new(self.config.smbus_base);
        smbus.host_reset();
...
mod acpi_impl {
    ...
    impl AcpiDevice for IntelGm965 {
        ...
        fn dsdt_aml(&self, config: &Self::Config) -> Vec<u8> {
            ...
            aml.extend_from_slice(&crate::core2_aml::cpu_devices_aml(2));
