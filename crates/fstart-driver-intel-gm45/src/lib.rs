...
register_bitfields! [u8,
    ...
    /// Undocumented host-bridge config register at 0xf0.
    pub HOST_BRIDGE_UNDOC_F0_REG [
        NORMAL_OPERATION_STROBE OFFSET(2) NUMBITS(1) []
    ],
...
register_structs! {
    ...
    pub Gm45MchBarRegs {
        ...
        (0x0098 => _pad3),
        (0x0200 => pub dcc: MmioReadWrite<u32>),
        (0x0204 => _pad4),
        ...
        (0x0f0a => _pad14),
        (0x0f0c => pub pm_f0c: MmioReadWrite<u16>),
        (0x0f0e => _pad15),
...
pci_type0_config! {
    ...
    pub struct Gm45HostBridgePciConfig {
        ...
        (0xe4 => _reserved_hb9),
        (0xf0 => pub undoc_f0: MmioReadWrite<u8, HOST_BRIDGE_UNDOC_F0_REG::Register>),
        (0xf1 => @END),
    }
}
...
impl IntelGm45 {
    ...
    fn fsb_clock_index(&self) -> usize {
        match (self.mchbar().regs().clkcfg.get() & 0x7) as u8 {
            ...
            raw => {
                fstart_log::error!(
                    "intel-gm45: unknown FSB strap {}, using FSB800 PM values",
                    raw
                );
                2
            }
    ...
    fn gm45_pm_init(&self) {
        const HGIPMC2: [u16; 4] = [0, 0x0ea6, 0x1194, 0x1777];
        const CLKCFG_C16: [u8; 4] = [0, 0x0e, 0x10, 0x15];
        const PM_F00: [u32; 4] = [0, 0x0000_0600, 0x0000_0700, 0x0000_0900];
        const PM_F04: [u32; 4] = [0, 0x0000_1d80, 0x0000_2380, 0x0000_2e80];
        const PM_F0C: [u16; 4] = [0, 0x0b96, 0x0c99, 0x10a4];
