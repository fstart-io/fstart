//! Orange Pi PC2 binding for the handwritten H3 flow.
use crate::Board;
...
pub struct OrangePiPc2Hooks;
impl SunxiEarlyBoardHooks<H3> for OrangePiPc2Hooks {
...
impl H3Board for Board {
    ...
    const CONFIG: &'static fstart_platform_sunxi::h3::H3Config = &crate::ORANGEPI_PC2_H5;
