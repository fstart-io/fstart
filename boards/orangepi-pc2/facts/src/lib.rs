//! Static hardware facts for Xunlong Orange Pi PC2 (Allwinner H5/sun50i).
...
pub const DRAMC_BASE: u64 = 0x01c6_2000;
...
pub const BOOTBLOCK_LOAD_ADDR: u64 = 0x0001_0000;
pub const MAIN_LOAD_ADDR: u64 = 0x4100_0000;
pub const HANDOFF_ADDR: u64 = MAIN_LOAD_ADDR - 0x1000;

pub const FIRMWARE_LOAD_ADDR: u64 = 0x0004_4000;
pub const KERNEL_LOAD_ADDR: u64 = 0x4a00_0000;
pub const FDT_ADDR: u64 = 0x4b00_0000;
