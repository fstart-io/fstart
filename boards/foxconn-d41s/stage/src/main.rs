//! Board-owned static stage binary for Foxconn D41S.
...
const HEAP_SIZE: usize = fstart_board_foxconn_d41s_facts::BOOTBLOCK_HEAP_SIZE;
#[cfg(not(fstart_stage_bootblock))]
const HEAP_SIZE: usize = fstart_board_foxconn_d41s_facts::RAMSTAGE_HEAP_SIZE;
...
pub extern "Rust" fn fstart_main(_handoff_ptr: usize) -> ! {
    match option_env!("FSTART_STAGE_NAME") {
        ...
        #[cfg(feature = "acpi")]
        Some("ramstage") => fstart_stage::run_static_board::<ramstage::RamstageBoard>(),
