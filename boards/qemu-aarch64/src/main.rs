//! Metadata helper binary for `qemu-aarch64`.
...
fn main() {
    ...
    match command.as_str() {
        ...
        "board-info" => print_ron(&fstart_board_qemu_aarch64::board_info()),
        "build-info" => print_ron(&fstart_board_qemu_aarch64::build_info()),
        "name" => println!("{}", fstart_board_qemu_aarch64::board_name()),
        other => {
