//! Metadata helper binary for `foxconn-d41s-uefi`.
...
fn main() {
    ...
    match command.as_str() {
        ...
        "board-info" => print_ron(&fstart_board_foxconn_d41s_uefi::board_info()),
        "build-info" => print_ron(&fstart_board_foxconn_d41s_uefi::build_info()),
        "name" => println!("{}", fstart_board_foxconn_d41s_uefi::board_name()),
        other => {
