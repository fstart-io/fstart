//! Bootblock fixed-flow adapter for Lichee RV Dock.

use fstart_board_licheerv_dock_facts as facts;
use fstart_driver_ns16550::Ns16550;
use fstart_driver_sunxi_d1_ccu::SunxiD1Ccu;
use fstart_driver_sunxi_d1_dramc::SunxiD1Dramc;
...
pub struct BootblockDevices {
    ccu: Option<SunxiD1Ccu>,
    console: StaticConsole<Ns16550>,
    dramc: Option<SunxiD1Dramc>,
