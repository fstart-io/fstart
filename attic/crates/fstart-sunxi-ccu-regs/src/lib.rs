//! Unported H3/D1/SPI sunxi CCU register definitions.
//!
//! A20-only definitions were ported to `crates/fstart-driver-sunxi`; this
//! attic module retains the other SoC-family register capital unchanged.
...
register_bitfields! [u32,
    ...
    pub SPI_CLK [
        M OFFSET(0) NUMBITS(4) [],
        N OFFSET(16) NUMBITS(2) [],
        CLK_SRC OFFSET(24) NUMBITS(2) [Osc24M = 0, Pll6 = 1, Pll5P = 2],
        ENABLE OFFSET(31) NUMBITS(1) []
    ]
];
